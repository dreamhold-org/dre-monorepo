...
namespace Espo\Modules\RealEstate\Tools\Request\Api;
 ...
 */
class GetMatchingProperties implements Action
{
    ...
    public function process(Request $request): Response
    {
        ...
        $collection = $this->service->findLinkedMatchingProperties($id, $searchParams);
